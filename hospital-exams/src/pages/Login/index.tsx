    ...
    <div className="min-h-screen grid place-items-center px-4">
      <div className="w-full max-w-sm rounded-2xl bg-bg-card/80 ring-1 ring-white/10 p-6">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h1 className="text-lg font-semibold">TeleMedi • Acesso</h1>
        </div>
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <button
            disabled={loading}
            className="w-full rounded-xl bg-white/10 px-3 py-2 hover:bg-white/20 transition disabled:opacity-60"
          >
